...
String coveragetype;
int expirydate;
Policy(int policynumber,String policyholdername,String coveragetype,int
expirydate){
...
PolicyHolderName :"+this.policyholdername+" Coverage : "+this.coveragetype+"
...
System.out.println("Policy with number " + policynumber + " not
found.");
}
}
public void Expiring(){
System.out.println("Policies expiring within 30 days:");
for (Map.Entry<Integer, List<Policy>> entry : tm.headMap(30,
true).entrySet()) {
...
for (Map.Entry<Integer, List<Policy>> entry : tm.headMap(1,
true).entrySet()) {
for (Policy p : entry.getValue()) {
...
Policy policy1 = new Policy(101, "Aman", "Health", 10);
Policy policy2 = new Policy(102, "Akshat", "Auto", 20);
Policy policy3 = new Policy(103, "Aryan", "Home", 5);
Policy policy4 = new Policy(104, "Anshul", "Travel", 50);
...
policyOps.showPolicyHolderName("Aman");
// Remove expiring policies with expiry date of 0
System.out.println("\nRemoving policies with expiry date 0 (none in this
case):");
policyOps.removeExpiringPolicies();
// Show all expiring policies again after removal
System.out.println("\nPolicies expiring in 30 days or less after
removal:");
policyOps.Expiring();
}
} 
